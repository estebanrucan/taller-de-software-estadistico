...
Sirve para decirle a R que seleccione solo las filas que cumplan la condición que indiquemos. Ejemplo:

Veamos el tipo de variables de la base de datos `iris`.
...
3. Genere una tabla con la cantidad de test hechos en los países de América del Sur en el último mes, ordenadas de menor a mayor.
