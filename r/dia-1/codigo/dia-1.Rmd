...
* Para no seleccionar una variable hay que anteponer un signo `-` antes de su nombre.
...
> Podemos ver que están todas las variables menos las que escribimos en la funcion `select`.
...
3. Genere una tabla con la cantidad de test hechos en América del Sur en el último mes, ordenadas de menor a mayor.
4. ¿Cuál es el país con mayor cantidad de casos por millón de habitantes en Europa desde el inicio de la pandemia?
5. Muestre información sobre la cantidad de casos que ha habido en las últimas 2 semanas a nivel continental en el mundo.